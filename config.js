...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~80650ddf392b40596a80627a78af7de6:5a2b4534486443335747513d').trim() || '',
    ...
    BOT_NAME: process.env.BOT_NAME || 'xenon',
    ...
    SUDO: process.env.SUDO || "254705470210",
